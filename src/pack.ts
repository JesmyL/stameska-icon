...
import iconPackOfEditTable from './icons/edit-table';
...
import iconPackOfMapsEditing from './icons/maps-editing';
...
import iconPackOfPropertyEdit from './icons/property-edit';
...
const pack: Record<StameskaIconName, string[]> = {
  ...
  PropertyEdit: iconPackOfPropertyEdit,
  EditTable: iconPackOfEditTable,
  ...
  MapsEditing: iconPackOfMapsEditing,
