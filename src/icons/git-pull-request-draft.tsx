...
export default [
  'GitPullRequestDraft',
  `< d="${d.d1}"i-c="s sj sr sw"/><C cx="6"cy="18"r="2"i-c="s sw"/><C cx="6"cy="6"r="2"i-c="s sw"/><C cx="18"cy="18"r="2"i-c="s sw"/>< d="${d.d2}"i-c="s sj sr sw"/>`,
  `<C cx="6"cy="18"r="2"i-c="f o7"/><C cx="6"cy="6"r="2"i-c="f o7"/><C cx="18"cy="18"r="2"i-c="f o7"/><C cx="6"cy="18"r="2"i-c="s sw"/><C cx="6"cy="6"r="2"i-c="s sw"/><C cx="18"cy="18"r="2"i-c="s sw"/>< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>`,
  `< d="${d.d1}"i-c="o7 s sj sr sw"/><C cx="6"cy="18"r="2"i-c="s sw"/><C cx="6"cy="6"r="2"i-c="s sw"/><C cx="18"cy="18"r="2"i-c="s sw"/>< d="${d.d2}"i-c="o7 s sj sr sw"/>`,
  `< d="${d.d3}"i-c="c f fr"/>< d="${d.d4}"i-c="c f fr"/>< d="${d.d5}"i-c="c f fr"/>< d="${d.d6}"i-c="c f fr"/>< d="${d.d7}"i-c="c f fr"/>`,
  `< d="${d.d3}"i-c="c f fr o7"/>< d="${d.d4}"i-c="c f fr"/>< d="${d.d5}"i-c="c f fr"/>< d="${d.d6}"i-c="c f fr"/>< d="${d.d7}"i-c="c f fr"/>`,
  `< d="${d.d1}"i-c="s sj sw"/><C cx="6"cy="18"r="2"i-c="s sj ss sw"/><C cx="6"cy="6"r="2"i-c="s sj ss sw"/><C cx="18"cy="18"r="2"i-c="s sj ss sw"/>< d="${d.d2}"i-c="s sj ss sw"/>`,
  `< d="${d.d8}"i-c="c f fr"/>< d="${d.d4}"i-c="f"/>< d="${d.d5}"i-c="f"/>< d="${d.d6}"i-c="f"/>< d="${d.d9}"i-c="c f fr"/>`
];
