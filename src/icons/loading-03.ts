...
export default [
  'Loading03',
  `< d="${d.d1}"i-c="s sr sw"/>< d="${d.d2}"i-c="s sr sw"/>< d="${d.d3}"i-c="s sr sw"/>< d="${d.d4}"i-c="s sr sw"/>< d="${d.d5}"i-c="s sr sw"/>< d="${d.d6}"i-c="s sr sw"/>< d="${d.d7}"i-c="s sr sw"/>< d="${d.d8}"i-c="s sr sw"/>`,
  `< d="${d.d1}"i-c="s sr sw"/>< d="${d.d2}"i-c="s sr sw"/>< d="${d.d3}"i-c="s sr sw"/>< d="${d.d4}"i-c="s sr sw"/>< d="${d.d5}"i-c="s sr sw"/>< d="${d.d6}"i-c="s sr sw"/>< d="${d.d7}"i-c="s sr sw"/>< d="${d.d8}"i-c="s sr sw"/>`,
  `< d="${d.d1}"i-c="s sr sw"/>< d="${d.d2}"i-c="o7 s sr sw"/>< d="${d.d3}"i-c="o7 s sr sw"/>< d="${d.d4}"i-c="s sr sw"/>< d="${d.d5}"i-c="o7 s sr sw"/>< d="${d.d6}"i-c="s sr sw"/>< d="${d.d7}"i-c="o7 s sr sw"/>< d="${d.d8}"i-c="s sr sw"/>`,
  ...
  `< d="${d.d9}"i-c="c f fr"/>< d="${d.d10}"i-c="c f fr o7"/>< d="${d.d11}"i-c="c f fr o7"/>< d="${d.d12}"i-c="c f fr"/>< d="${d.d13}"i-c="c f fr o7"/>< d="${d.d14}"i-c="c f fr"/>< d="${d.d15}"i-c="c f fr o7"/>< d="${d.d16}"i-c="c f fr"/>`,
  `< d="${d.d17}"i-c="s sw"/>< d="${d.d18}"i-c="s sw"/>< d="${d.d19}"i-c="s sw"/>< d="${d.d20}"i-c="s sw"/>< d="${d.d21}"i-c="s sw"/>< d="${d.d22}"i-c="s sw"/>< d="${d.d23}"i-c="s sw"/>< d="${d.d24}"i-c="s sw"/>`,
  `< d="${d.d25}"i-c="c f fr"/>< d="${d.d26}"i-c="c f fr"/>< d="${d.d27}"i-c="c f fr"/>< d="${d.d28}"i-c="c f fr"/>< d="${d.d29}"i-c="c f fr"/>< d="${d.d30}"i-c="c f fr"/>< d="${d.d31}"i-c="c f fr"/>< d="${d.d32}"i-c="c f fr"/>`
];
