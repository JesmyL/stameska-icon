...
export default [
  ...
  `< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/><C cx="6.5"cy="6.5"r="3.5"i-c="s sj sr sw"/><C cx="6.5"cy="17.5"r="3.5"i-c="s sj sr sw"/>`,
  `<C cx="6.5"cy="6.5"r="3.5"i-c="f o7"/><C cx="6.5"cy="17.5"r="3.5"i-c="f o7"/>< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/><C cx="6.5"cy="6.5"r="3.5"i-c="s sj sr sw"/><C cx="6.5"cy="17.5"r="3.5"i-c="s sj sr sw"/>`,
  `< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="o7 s sj sr sw"/>< d="${d.d3}"i-c="o7 s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/><C cx="6.5"cy="6.5"r="3.5"i-c="s sj sr sw"/><C cx="6.5"cy="17.5"r="3.5"i-c="s sj sr sw"/>`,
  `< d="${d.d5}"i-c="c f fr"/>< d="${d.d6}"i-c="f"/>< d="${d.d7}"i-c="f"/>`,
  `< d="${d.d5}"i-c="c f fr"/>< d="${d.d6}"i-c="f o7"/>< d="${d.d7}"i-c="f o7"/>`,
  `< d="${d.d8}"i-c="s sj sw"/>< d="${d.d9}"i-c="s sj sw"/>< d="${d.d10}"i-c="s sj sw"/>< d="${d.d11}"i-c="s sj sw"/><C cx="6.5"cy="6.5"r="3.5"i-c="s sj sw"/><C cx="6.5"cy="17.5"r="3.5"i-c="s sj sw"/>`,
  `< d="${d.d12}"i-c="c f fr"/>< d="${d.d13}"i-c="c f fr"/>< d="${d.d14}"i-c="c f fr"/>< d="${d.d15}"i-c="c f fr"/>< d="${d.d16}"i-c="f"/>< d="${d.d17}"i-c="f"/>`
];
