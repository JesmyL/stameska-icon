...
export default [
  'Route01',
  `<C cx="18"cy="5"r="3"i-c="s sj sr sw"/><C cx="6"cy="19"r="3"i-c="s sj sr sw"/>< d="${d.d1}"i-c="s sj sr sw"/>`,
  `<C cx="18"cy="5"r="3"i-c="f o7"/><C cx="18"cy="5"r="3"i-c="s sj sr sw"/><C cx="6"cy="19"r="3"i-c="f o7"/><C cx="6"cy="19"r="3"i-c="s sj sr sw"/>< d="${d.d1}"i-c="s sj sr sw"/>`,
  `<C cx="18"cy="5"r="3"i-c="o7 s sj sr sw"/><C cx="6"cy="19"r="3"i-c="o7 s sj sr sw"/>< d="${d.d1}"i-c="s sj sr sw"/>`,
  `< d="${d.d2}"i-c="f"/>< d="${d.d3}"i-c="f"/>< d="${d.d4}"i-c="c f fr"/>`,
  `< d="${d.d2}"i-c="f"/>< d="${d.d3}"i-c="f"/>< d="${d.d4}"i-c="c f fr o7"/>`,
  `<C cx="18"cy="5"r="3"i-c="s sj sw"/><C cx="6"cy="19"r="3"i-c="s sj sw"/>< d="${d.d1}"i-c="s sj sw"/>`,
