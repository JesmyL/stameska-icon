...
export default [
  'SignalNo02',
  `< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d4}"i-c="s sr sw"/>`,
  `< d="${d.d1}"i-c="o7 s sj sr sw"/>< d="${d.d2}"i-c="o7 s sj sr sw"/>< d="${d.d3}"i-c="o7 s sj sr sw"/>< d="${d.d4}"i-c="o7 s sr sw"/>`,
  `< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d4}"i-c="o7 s sr sw"/>`,
  `< d="${d.d5}"i-c="f"/>< d="${d.d6}"i-c="f"/>< d="${d.d7}"i-c="f"/>< d="${d.d8}"i-c="c f fr"/>`,
  `< d="${d.d5}"i-c="f"/>< d="${d.d6}"i-c="f"/>< d="${d.d7}"i-c="f"/>< d="${d.d8}"i-c="c f fr o7"/>`,
