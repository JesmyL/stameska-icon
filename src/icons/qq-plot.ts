...
export default [
  'QqPlot',
  `< d="${d.d1}"i-c="s sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/>< d="${d.d5}"i-c="s sj sr sw"/>< d="${d.d6}"i-c="s sj sr sw"/>< d="${d.d7}"i-c="s sj sr sw"/>`,
  `< d="${d.d1}"i-c="s sr sw"/>< d="${d.d2}"i-c="o7 s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/>< d="${d.d5}"i-c="s sj sr sw"/>< d="${d.d6}"i-c="s sj sr sw"/>< d="${d.d7}"i-c="s sj sr sw"/>`,
  `< d="${d.d1}"i-c="s sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="o7 s sj sr sw"/>< d="${d.d4}"i-c="o7 s sj sr sw"/>< d="${d.d5}"i-c="o7 s sj sr sw"/>< d="${d.d6}"i-c="o7 s sj sr sw"/>< d="${d.d7}"i-c="o7 s sj sr sw"/>`,
  `< d="${d.d8}"i-c="c f fr"/>< d="${d.d9}"i-c="c f fr"/>< d="${d.d10}"i-c="c f fr"/>< d="${d.d11}"i-c="c f fr"/>< d="${d.d12}"i-c="c f fr"/>< d="${d.d13}"i-c="c f fr"/>`,
  `< d="${d.d14}"i-c="c f fr"/>< d="${d.d15}"i-c="c f fr"/>< d="${d.d9}"i-c="c f fr o7"/>< d="${d.d10}"i-c="c f fr o7"/>< d="${d.d11}"i-c="c f fr o7"/>< d="${d.d12}"i-c="c f fr o7"/>< d="${d.d13}"i-c="c f fr o7"/>`,
  `< d="${d.d16}"i-c="s sj sw"/>< d="${d.d17}"i-c="s sj sw"/>< d="${d.d3}"i-c="s sj ss sw"/>< d="${d.d4}"i-c="s sj ss sw"/>< d="${d.d5}"i-c="s sj ss sw"/>< d="${d.d6}"i-c="s sj ss sw"/>< d="${d.d7}"i-c="s sj ss sw"/>`,
  `< d="${d.d18}"i-c="c f fr"/>< d="${d.d19}"i-c="c f fr"/>< d="${d.d20}"i-c="c f fr"/>< d="${d.d21}"i-c="c f fr"/>< d="${d.d22}"i-c="c f fr"/>< d="${d.d23}"i-c="c f fr"/>< d="${d.d24}"i-c="c f fr"/>`
];
