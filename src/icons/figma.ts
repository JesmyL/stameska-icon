...
export default [
  'Figma',
  `<C cx="15"cy="12"r="3"i-c="s sj sw"/>< d="${d.d1}"i-c="s sj sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/>`,
  `<C cx="15"cy="12"r="3"i-c="f o7"/>< d="${d.d1}"i-c="f o7"/><C cx="15"cy="12"r="3"i-c="s sj sw"/>< d="${d.d1}"i-c="s sj sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="f o7 s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/>`,
  `<C cx="15"cy="12"r="3"i-c="o7 s sj sw"/>< d="${d.d1}"i-c="o7 s sj sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="o7 s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/>`,
  `<C cx="15.5"cy="12.1641"r="3.5"i-c="f"/>< d="${d.d5}"i-c="f"/>`,
  `<C cx="15.5"cy="12.1641"r="3.5"i-c="f o7"/>< d="${d.d5}"i-c="f"/>`,
  `<C cx="15"cy="12"r="3"i-c="s sj sw"/>< d="${d.d1}"i-c="s sj sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/>`,
  `<C cx="15"cy="12"r="3"i-c="f"/>< d="${d.d1}"i-c="f"/>< d="${d.d2}"i-c="f"/>< d="${d.d3}"i-c="f"/>< d="${d.d4}"i-c="f"/>`
];
