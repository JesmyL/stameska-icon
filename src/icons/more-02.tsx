...
export default [
  ...
  `<g i-c="o7">< d="${d.d3}"i-c="f"/>< d="${d.d2}"i-c="f"/>< d="${d.d1}"i-c="f"/>< d="${d.d8}"i-c="f"/>< d="${d.d4}"i-c="f"/>< d="${d.d9}"i-c="f"/>< d="${d.d7}"i-c="f"/>< d="${d.d5}"i-c="f"/>< d="${d.d6}"i-c="f"/></g>< d="${d.d1}"i-c="s sw"/>< d="${d.d2}"i-c="s sw"/>< d="${d.d3}"i-c="s sw"/>< d="${d.d4}"i-c="s sw"/>< d="${d.d5}"i-c="s sw"/>< d="${d.d6}"i-c="s sw"/>< d="${d.d7}"i-c="s sw"/>< d="${d.d8}"i-c="s sw"/>< d="${d.d9}"i-c="s sw"/>`,
  `< d="${d.d1}"i-c="s sw"/>< d="${d.d2}"i-c="o7 s sw"/>< d="${d.d3}"i-c="s sw"/>< d="${d.d4}"i-c="s sw"/>< d="${d.d5}"i-c="s sw"/>< d="${d.d6}"i-c="o7 s sw"/>< d="${d.d7}"i-c="o7 s sw"/>< d="${d.d8}"i-c="s sw"/>< d="${d.d9}"i-c="s sw"/>`,
  ...
  `< d="${d.d10}"i-c="c f fr"/>< d="${d.d11}"i-c="c f fr"/>< d="${d.d12}"i-c="c f fr"/>< d="${d.d13}"i-c="c f fr"/>< d="${d.d14}"i-c="c f fr"/>< d="${d.d15}"i-c="c f fr"/>< d="${d.d16}"i-c="c f fr o7"/>< d="${d.d17}"i-c="c f fr o7"/>< d="${d.d18}"i-c="c f fr o7"/>`,
  `< d="${d.d1}"i-c="s sw"/>< d="${d.d2}"i-c="s sw"/>< d="${d.d3}"i-c="s sw"/>< d="${d.d4}"i-c="s sw"/>< d="${d.d5}"i-c="s sw"/>< d="${d.d6}"i-c="s sw"/>< d="${d.d7}"i-c="s sw"/>< d="${d.d8}"i-c="s sw"/>< d="${d.d9}"i-c="s sw"/>`,
  `< d="${d.d19}"i-c="f"/>< d="${d.d20}"i-c="f"/>< d="${d.d21}"i-c="f"/>< d="${d.d22}"i-c="f"/>< d="${d.d23}"i-c="f"/>< d="${d.d24}"i-c="f"/>< d="${d.d25}"i-c="f"/>< d="${d.d26}"i-c="f"/>< d="${d.d27}"i-c="f"/>`
];
