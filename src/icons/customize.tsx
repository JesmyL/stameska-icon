...
export default [
  ...
  `< d="${d.d5}"i-c="f o7"/>< d="${d.d6}"i-c="f o7"/>< d="${d.d2}"i-c="s sw"/>< d="${d.d1}"i-c="s sw"/>< d="${d.d4}"i-c="s sw"/>< d="${d.d3}"i-c="s sw"/>`,
  `< d="${d.d1}"i-c="o7 s sw"/>< d="${d.d2}"i-c="s sw"/>< d="${d.d3}"i-c="o7 s sw"/>< d="${d.d4}"i-c="s sw"/>`,
  `< d="${d.d7}"i-c="c f fr"/>< d="${d.d8}"i-c="c f fr"/>`,
  `<R x="2.25"y="2.25"rx="4.25"i-c="f h0 o7 w9"/><C cx="6.5"cy="6.5"r="2.5"i-c="f"/><R x="2.25"y="13.25"rx="4.25"i-c="f h0 o7 w9"/><C cx="17.5"cy="17.5"r="2.5"i-c="f"/>`,
  `< d="${d.d9}"i-c="s sj sw"/>< d="${d.d10}"i-c="s sj sw"/>< d="${d.d11}"i-c="s sj sw"/>< d="${d.d12}"i-c="s sj sw"/>`,
  `< d="${d.d13}"i-c="f"/>< d="${d.d14}"i-c="f"/>< d="${d.d15}"i-c="f"/>< d="${d.d16}"i-c="f"/>`
];
