...
export default [
  ...
  `< d="${d.d10}"i-c="s sr sw"/>< d="${d.d11}"i-c="o7 s sr sw"/>< d="${d.d12}"i-c="o7 s sr sw"/>< d="${d.d13}"i-c="s sr sw"/>< d="${d.d14}"i-c="o7 s sr sw"/>< d="${d.d15}"i-c="s sr sw"/>`,
  ...
  `< d="${d.d16}"i-c="c f fr"/>< d="${d.d17}"i-c="c f fr"/>< d="${d.d18}"i-c="c f fr"/>< d="${d.d19}"i-c="c f fr"/>< d="${d.d20}"i-c="c f fr"/>< d="${d.d21}"i-c="c f fr"/>< d="${d.d22}"i-c="c f fr"/>< d="${d.d23}"i-c="c f fr"/>< d="${d.d24}"i-c="c f fr"/>`,
  `< d="${d.d16}"i-c="c f fr"/>< d="${d.d17}"i-c="c f fr o7"/>< d="${d.d18}"i-c="c f fr"/>< d="${d.d19}"i-c="c f fr"/>< d="${d.d20}"i-c="c f fr"/>< d="${d.d21}"i-c="c f fr"/>< d="${d.d22}"i-c="c f fr o7"/>< d="${d.d23}"i-c="c f fr"/>< d="${d.d24}"i-c="c f fr o7"/>`,
  ...
  `< d="${d.d25}"i-c="c f fr"/>< d="${d.d26}"i-c="c f fr"/>< d="${d.d27}"i-c="c f fr"/>< d="${d.d28}"i-c="c f fr"/>< d="${d.d29}"i-c="c f fr"/>< d="${d.d30}"i-c="c f fr"/>< d="${d.d31}"i-c="c f fr"/>< d="${d.d32}"i-c="c f fr"/>< d="${d.d33}"i-c="c f fr"/>`
];
