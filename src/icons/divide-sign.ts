...
export default [
  'DivideSign',
  `< d="${d.d1}"i-c="s sr sw"/>< d="${d.d2}"i-c="s sw"/>< d="${d.d3}"i-c="s sw"/>`,
  `< d="${d.d1}"i-c="s sr sw"/>< d="${d.d2}"i-c="f o7"/>< d="${d.d2}"i-c="s sw"/>< d="${d.d3}"i-c="f o7"/>< d="${d.d3}"i-c="s sw"/>`,
  `< d="${d.d1}"i-c="s sr sw"/>< d="${d.d2}"i-c="o7 s sw"/>< d="${d.d3}"i-c="o7 s sw"/>`,
  `< d="${d.d4}"i-c="c f fr"/>< d="${d.d5}"i-c="f"/>< d="${d.d6}"i-c="f"/>`,
  `< d="${d.d4}"i-c="c f fr"/>< d="${d.d5}"i-c="f o7"/>< d="${d.d6}"i-c="f o7"/>`,
  `< d="${d.d1}"i-c="s sj sw"/>< d="${d.d2}"i-c="s sj sw"/>< d="${d.d3}"i-c="s sj sw"/>`,
  `< d="${d.d7}"i-c="c f fr"/>< d="${d.d5}"i-c="f"/>< d="${d.d6}"i-c="f"/>`
];
