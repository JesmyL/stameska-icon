...
export default [
  ...
  `< d="${d.d7}"i-c="f"/>< d="${d.d8}"i-c="c f fr"/>< d="${d.d9}"i-c="c f fr"/>< d="${d.d10}"i-c="c f fr"/>< d="${d.d11}"i-c="c f fr o7"/>`,
  `< d="${d.d12}"i-c="s sj sw"/>< d="${d.d3}"i-c="s sj sw"/>< d="${d.d4}"i-c="s sj sw"/>< d="${d.d5}"i-c="s sj sw"/>< d="${d.d13}"i-c="s sj sw"/>`,
  `< d="${d.d14}"i-c="f"/>< d="${d.d15}"i-c="c f fr"/>< d="${d.d16}"i-c="c f fr"/>< d="${d.d17}"i-c="c f fr"/>< d="${d.d18}"i-c="c f fr"/>`
];
