...
export default [
  ...
  `< d="${d.d5}"i-c="f o7"/>< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/>`,
  `< d="${d.d1}"i-c="o7 s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="o7 s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/>`,
  `< d="${d.d6}"i-c="c f fr"/>< d="${d.d7}"i-c="c f fr"/>< d="${d.d8}"i-c="c f fr"/>< d="${d.d9}"i-c="c f fr"/>`,
  `< d="${d.d6}"i-c="c f fr"/>< d="${d.d7}"i-c="c f fr o7"/>< d="${d.d8}"i-c="c f fr o7"/>< d="${d.d9}"i-c="c f fr o7"/>`,
  `< d="${d.d10}"i-c="s sj sw"/>< d="${d.d11}"i-c="s sj sw"/>< d="${d.d2}"i-c="s sj sw"/>< d="${d.d3}"i-c="s sj sw"/>`,
