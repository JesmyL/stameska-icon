...
export default [
  'Crowdfunding',
  `<C cx="12"cy="5"r="3"i-c="s sw"/><C cx="12"cy="20"r="2"i-c="s sw"/><C cx="20"cy="20"r="2"i-c="s sw"/><C cx="4"cy="20"r="2"i-c="s sw"/>< d="${d.d1}"i-c="s sr sw"/>< d="${d.d2}"i-c="s sr sw"/>`,
  `<C cx="12"cy="5"r="3"i-c="f o7"/><C cx="20"cy="20"r="2"i-c="f o7"/><C cx="4"cy="20"r="2"i-c="f o7"/><C cx="12"cy="5"r="3"i-c="s sw"/><C cx="12"cy="20"r="2"i-c="s sw"/><C cx="20"cy="20"r="2"i-c="s sw"/><C cx="4"cy="20"r="2"i-c="s sw"/>< d="${d.d1}"i-c="s sr sw"/>< d="${d.d2}"i-c="s sr sw"/>`,
  `<C cx="12"cy="5"r="3"i-c="s sw"/><C cx="12"cy="20"r="2"i-c="s sw"/><C cx="20"cy="20"r="2"i-c="s sw"/><C cx="4"cy="20"r="2"i-c="s sw"/>< d="${d.d3}"i-c="o7 s sr sw"/>`,
  `< d="${d.d4}"i-c="f"/><C cx="12"cy="20.5"r="2"i-c="f"/><C cx="20"cy="20.5"r="2"i-c="f"/><C cx="4"cy="20.5"r="2"i-c="f"/>< d="${d.d5}"i-c="c f fr"/>`,
  `< d="${d.d4}"i-c="f"/><C cx="12"cy="20.5"r="2"i-c="f"/><C cx="20"cy="20.5"r="2"i-c="f"/><C cx="4"cy="20.5"r="2"i-c="f"/>< d="${d.d5}"i-c="c f fr o7"/>`,
  `<C cx="12"cy="5"r="3"i-c="s sj sw"/><C cx="12"cy="20"r="2"i-c="s sj sw"/><C cx="20"cy="20"r="2"i-c="s sj sw"/><C cx="4"cy="20"r="2"i-c="s sj sw"/>< d="${d.d6}"i-c="s sj sw"/>< d="${d.d7}"i-c="s sj sw"/>`,
  `< d="${d.d8}"i-c="f"/>< d="${d.d9}"i-c="f"/>< d="${d.d10}"i-c="f"/>< d="${d.d11}"i-c="f"/>< d="${d.d12}"i-c="c f fr"/>`
];
