...
export default [
  'DialpadCircle02',
  `< d="${d.d1}"i-c="s sw"/>< d="${d.d2}"i-c="s sw"/>< d="${d.d3}"i-c="s sw"/>< d="${d.d4}"i-c="s sw"/>< d="${d.d5}"i-c="s sw"/>< d="${d.d6}"i-c="s sw"/>< d="${d.d7}"i-c="s sw"/>`,
  `<g i-c="o7">< d="${d.d3}"i-c="f"/>< d="${d.d4}"i-c="f"/>< d="${d.d5}"i-c="f"/></g>< d="${d.d1}"i-c="s sw"/>< d="${d.d2}"i-c="s sw"/>< d="${d.d3}"i-c="s sw"/>< d="${d.d4}"i-c="s sw"/>< d="${d.d5}"i-c="s sw"/>< d="${d.d6}"i-c="s sw"/>< d="${d.d7}"i-c="s sw"/>`,
  `< d="${d.d1}"i-c="s sw"/>< d="${d.d2}"i-c="o7 s sw"/>< d="${d.d3}"i-c="s sw"/>< d="${d.d4}"i-c="s sw"/>< d="${d.d5}"i-c="s sw"/>< d="${d.d6}"i-c="o7 s sw"/>< d="${d.d7}"i-c="s sw"/>`,
  `< d="${d.d8}"i-c="f"/>< d="${d.d9}"i-c="f"/>< d="${d.d10}"i-c="f"/>< d="${d.d11}"i-c="f"/>< d="${d.d12}"i-c="f"/>< d="${d.d13}"i-c="f"/>< d="${d.d14}"i-c="f"/>`,
  `< d="${d.d8}"i-c="f"/>< d="${d.d9}"i-c="f o7"/>< d="${d.d10}"i-c="f"/>< d="${d.d11}"i-c="f o7"/>< d="${d.d12}"i-c="f"/>< d="${d.d13}"i-c="f o7"/>< d="${d.d14}"i-c="f o7"/>`,
  `< d="${d.d1}"i-c="s sw"/>< d="${d.d2}"i-c="s sw"/>< d="${d.d3}"i-c="s sw"/>< d="${d.d4}"i-c="s sw"/>< d="${d.d5}"i-c="s sw"/>< d="${d.d6}"i-c="s sw"/>< d="${d.d7}"i-c="s sw"/>`,
  `< d="${d.d8}"i-c="f"/>< d="${d.d11}"i-c="f"/>< d="${d.d9}"i-c="f"/>< d="${d.d12}"i-c="f"/>< d="${d.d13}"i-c="f"/>< d="${d.d10}"i-c="f"/>< d="${d.d14}"i-c="f"/>`
];
