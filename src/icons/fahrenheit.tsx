...
export default [
  'Fahrenheit',
  `<C cx="5"cy="6"r="2"i-c="s sj sr sw"/>< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>`,
  `<C cx="5"cy="6"r="2"i-c="f o7"/><C cx="5"cy="6"r="2"i-c="s sj sr sw"/>< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>`,
  `<C cx="5"cy="6"r="2"i-c="o7 s sj sr sw"/>< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>`,
  `< d="${d.d3}"i-c="c f fr"/>< d="${d.d4}"i-c="f"/>`,
  `< d="${d.d3}"i-c="c f fr"/>< d="${d.d4}"i-c="f o7"/>`,
  `<C cx="5"cy="6"r="2"i-c="s sj sw"/>< d="${d.d5}"i-c="s sw"/>< d="${d.d2}"i-c="s sj sw"/>`,
  `< d="${d.d6}"i-c="c f fr"/>< d="${d.d7}"i-c="f"/>`
];
