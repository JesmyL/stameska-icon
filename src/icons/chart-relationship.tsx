...
export default [
  'ChartRelationship',
  `< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/><C cx="6.44444"cy="6.44444"r="4.44444"i-c="s sw"/><C cx="5"cy="20"r="2"i-c="s sw"/><C cx="16"cy="16"r="2"i-c="s sw"/><C cx="20"cy="5"r="2"i-c="s sw"/>`,
  `< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/><C cx="6.44444"cy="6.44444"r="4.44444"i-c="s sw"/><C cx="6.44444"cy="6.44444"r="4.44444"i-c="f o7"/><C cx="5"cy="20"r="2"i-c="s sw"/><C cx="16"cy="16"r="2"i-c="s sw"/><C cx="20"cy="5"r="2"i-c="s sw"/>`,
  `< d="${d.d1}"i-c="o7 s sj sr sw"/>< d="${d.d2}"i-c="o7 s sj sr sw"/>< d="${d.d3}"i-c="o7 s sj sr sw"/><C cx="6.44444"cy="6.44444"r="4.44444"i-c="s sw"/><C cx="5"cy="20"r="2"i-c="s sw"/><C cx="16"cy="16"r="2"i-c="s sw"/><C cx="20"cy="5"r="2"i-c="s sw"/>`,
  `< d="${d.d4}"i-c="c f fr"/>< d="${d.d5}"i-c="c f fr"/>< d="${d.d6}"i-c="c f fr"/><C cx="5.94444"cy="5.94444"r="4.44444"i-c="f"/>< d="${d.d7}"i-c="f"/><C cx="16"cy="16"r="2.5"i-c="f"/>< d="${d.d8}"i-c="f"/>`,
  `< d="${d.d4}"i-c="c f fr o7"/>< d="${d.d5}"i-c="c f fr o7"/>< d="${d.d6}"i-c="c f fr o7"/><C cx="5.94444"cy="5.94444"r="4.44444"i-c="f"/>< d="${d.d7}"i-c="f"/><C cx="16"cy="16"r="2.5"i-c="f"/>< d="${d.d8}"i-c="f"/>`,
  `< d="${d.d1}"i-c="s sj sr sw"/>< d="${d.d2}"i-c="s sj sr sw"/>< d="${d.d3}"i-c="s sj sr sw"/><C cx="6.44444"cy="6.44444"r="4.44444"i-c="s sj sw"/><C cx="5"cy="20"r="2"i-c="s sj sw"/><C cx="16"cy="16"r="2"i-c="s sj sw"/><C cx="20"cy="5"r="2"i-c="s sj sw"/>`,
  `< d="${d.d9}"i-c="c f fr"/>< d="${d.d10}"i-c="f"/>< d="${d.d11}"i-c="f"/>< d="${d.d12}"i-c="f"/>< d="${d.d13}"i-c="f"/>`
];
