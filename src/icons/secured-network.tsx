...
export default [
  'SecuredNetwork',
  `< d="${d.d1}"i-c="s sw"/>< d="${d.d2}"i-c="s sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/>`,
  `< d="${d.d1}"i-c="f o7"/>< d="${d.d1}"i-c="s sw"/>< d="${d.d2}"i-c="s sw"/>< d="${d.d3}"i-c="s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/>`,
  `< d="${d.d1}"i-c="s sw"/>< d="${d.d2}"i-c="o7 s sw"/>< d="${d.d3}"i-c="o7 s sj sr sw"/>< d="${d.d4}"i-c="s sj sr sw"/>`,
  `< d="${d.d5}"i-c="c f fr"/>< d="${d.d6}"i-c="c f fr"/>`,
  `< d="${d.d6}"i-c="c f fr o7"/>< d="${d.d5}"i-c="c f fr"/>`,
  `< d="${d.d1}"i-c="s sj ss sw"/>< d="${d.d2}"i-c="s sj sw"/>< d="${d.d3}"i-c="s sj ss sw"/>< d="${d.d4}"i-c="s sj sw"/>`,
