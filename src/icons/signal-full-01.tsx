...
export default [
  ...
  `< d="${d.d7}"i-c="f"/>< d="${d.d8}"i-c="c f fr"/>< d="${d.d9}"i-c="c f fr"/>< d="${d.d10}"i-c="c f fr o7"/>< d="${d.d11}"i-c="c f fr o7"/>`,
  `< d="${d.d12}"i-c="s sj sw"/>< d="${d.d3}"i-c="s sj sw"/>< d="${d.d4}"i-c="s sj sw"/>< d="${d.d5}"i-c="s sj sw"/>< d="${d.d6}"i-c="s sj sw"/>`,
